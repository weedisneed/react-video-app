...
const Header = () => {
    ...
    const {isOpen,onOpen,onClose} = useDisclosure()    //anythin spelled use is HOOK
    ...
    <>
        ...
        <Drawer isOpen={isOpen} placement="left" onClose={onClose}>
            ...
            <DrawerContent>
                <DrawerCloseButton />
                <DrawerHeader>SHELBY PVT LTD</DrawerHeader>
                <DrawerBody>
                    ...
                    <HStack pos={'absolute'} bottom={'10'} left={'0'} w={'full'} justifyContent={'space-evenly'}>
                        ...
                        <Button onClick={onClose} colorScheme={'twitter'} variant={'outline'}>
